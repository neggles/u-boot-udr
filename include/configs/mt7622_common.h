...
#define CONFIG_NOR_UBOOT_SIZE              0x160000 //Uboot max size 1408k
...
#define CONFIG_BOOTCMD_EMMCDUAL_BOOTARGS \
	"img_suffix=\0" \
	"rootargsemmcdual0="						\
		"setenv rootargs root=rootfs$img_suffix\0"	\
	"bootargsemmcdual0="							\
		"run rootargsemmcdual0; setenv bootargs $rootargs console=ttyS0,115200 panic=3 leds_mcu=$leds_mcu $bootargsextra; printenv bootargs\0"	\
	"bootkernel="									\
		"run bootargsemmcdual0; ext4load mmc 0:1 $loadaddr uImage; bootm $fitbootconf\0"	\
	"bootkernelbkp="									\
		"setenv img_suffix .bkp; run bootargsemmcdual0; ext4load mmc 0:1 $loadaddr uImage$img_suffix; bootm $fitbootconf\0"

#define CONFIG_FIT_CONF \
	"fitbootconf="__stringify(CONFIG_SYS_LOAD_ADDR)"#"__stringify(CONFIG_DEVICE_NAME)"@1\0"

#define CONFIG_BOOT_UPD \
	"delenv=env default -a -f; saveenv; reset\0" \
	"bootupd=download_setting uboot; tftpboot ${loadaddr} ${uboot_filename}; run wr_uboot; invaild_env\0" \
	"bootupdb=loadb; run wr_uboot; invaild_env\0" \
	"boottftp=download_setting kernel; mmc init; run bootargsemmcdual0; tftpboot ${loadaddr} ${kernel_filename}; bootm\0"

#define CONFIG_UBOOT_FILENAME \
	"uboot_filename=u-boot-mtk.bin\0"

#define CONFIG_EXTRA_FIT_SETTINGS \
	CONFIG_FIT_CONF \
	CONFIG_BOOTCMD_EMMCDUAL_BOOTARGS \
	CONFIG_BOOTCMD_EMMCDUAL_FIT \
	CONFIG_BOOTCMD_EMMCDUAL_FIT_RECOVERY \
	ENV_WRITE_UBOOT \
	CONFIG_UBOOT_FILENAME \
	CONFIG_BOOT_UPD
...
#define CONFIG_SYS_I2C_SPEED               0x61a80
#define CONFIG_SOFT_I2C_GPIO_SDA           0xe
#define CONFIG_SOFT_I2C_GPIO_SCL           0xf
...
#endif /*CONFIG_MTK_MLC_NAND_SUPPORT*/
...
#define CONFIG_DOS_PARTITION
#endif /* defined(ON_BOARD_EMMC_COMPONENT) || defined(OFF_BOARD_SD_CARD_COMPONENT) */
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	"loadaddr_payload=" __stringify(CONFIG_SYS_LOAD_ADDR) "\0" \
	ENV_DEVICE_SETTINGS \
	CONFIG_EXTRA_FIT_SETTINGS
#if 0
#define CONFIG_EXTRA_ENV_SETTINGS \
	"fdt_high=0x6c000000\0" \
	ENV_DEVICE_SETTINGS
...
#define CONFIG_DEFAULT_DEVICE_TREE "mt7622_ubnt"
...
#define UBNT_LOG_BUFF_SIZE  (32 * 1024)

#define CONFIG_BOOTCOMMAND  "run emmcdualfit"
#define CONFIG_BOOTCOMMAND_RECOVERY "run emmcdualfitrecovery"
...
#endif
#define MT7622_SPI1_CLK		73
#define MT7622_SPI1_MOSI	74
#define MT7622_SPI1_MISO	75
#define MT7622_SPI1_CS		76
#define MT7622_LCM_DC		77
#define MT7622_LCM_RESET	85

// jeffrey: TODO move to other place
#define CFG_FLASH_BASE          0x30000000
#define CFG_FLASH_SECTOR_SIZE   (64 * 1024)

/* TODO: no header found (check gpio support) */
#define UBNT_DISABLE_FDTDEC_GPIO_API
