...
ifeq ($(MT7622), y)
ifeq ($(CONFIG_MT7622_EVB), y)
mtk_board = mt7622_evb_config
mtk_chip = mt7622
endif
ifeq ($(CONFIG_MT7622_UDK), y)
mtk_board = mt7622_udk_config
mtk_chip = mt7622
endif
ifeq ($(CONFIG_MT7622_UDM_LITE), y)
mtk_board = mt7622_udm_lite_config
mtk_chip = mt7622
endif
ifeq ($(CONFIG_MT7622_UDR), y)
mtk_board = mt7622_udr_config
mtk_chip = mt7622
endif
endif
...
ifeq ($(ON_BOARD_SPI_NOR_FLASH_COMPONENT), y)
spl/u-boot-spl-mtk-pad.bin: spl/u-boot-spl-mtk-nor.bin FORCE
	$(call if_changed,spl_pad_ff)
endif
ifeq ($(ON_BOARD_2K_64_SNAND_COMPONENT), y)
spl/u-boot-spl-mtk-pad.bin: spl/u-boot-spl-mtk-nand2k_64.bin FORCE
	$(call if_changed,spl_pad_ff)
endif
ifeq ($(ON_BOARD_2K_128_SNAND_COMPONENT), y)
spl/u-boot-spl-mtk-pad.bin: spl/u-boot-spl-mtk-nand2k_128.bin FORCE
	$(call if_changed,spl_pad_ff)
endif
ifeq ($(ON_BOARD_4K_256_SNAND_COMPONENT), y)
spl/u-boot-spl-mtk-pad.bin: spl/u-boot-spl-mtk-nand4k_256.bin FORCE
	$(call if_changed,spl_pad_ff)
endif

# Concatenate spl and u-boot
...
u-boot-mtk.bin: u-boot-dtb.bin FORCE
	$(call if_changed,mkimage)
...
#u-boot.elf: u-boot.bin ubnt_app_addr.sym
...
#      --just-symbols=ubnt_app_addr.sym                         \
...
#u-boot.lds: $(LDSCRIPT) prepare FORCE ubnt_app_addr.sym
...
#ubnt_app_addr.sym:
#	echo  "SECTIONS { _ubnt_app_flash_data = _image_binary_end; }" > $@
